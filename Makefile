...
INCPATH = -I $(INCLUDE_DIR)  -I $(CTARTA)/include -I$(CTARTA)/include/packet -L$(CTARTA)/lib -I$(HESSIOSYS)hessioxxx/include
...
LIBS = $(INCPATH) -lstdc++ -lpacket -lCTAUtils -lhessio -lhessio++
...
exe: $(EXE_NAME1) $(EXE_NAME2) #$(EXE_NAME3)
